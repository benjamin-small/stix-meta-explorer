...
const grouping: StixObjectType = {
  ...
  relationshipNote: 'Grouping references objects through its object_refs property rather than SRO relationships. Custom relationships may be defined via extensions.',
  relationships: emptyRels(),
  example: {},
...
const incident: StixObjectType = {
  ...
  relationshipNote: 'The STIX 2.1 spec reserves Incident as a stub type. Relationships are implementation-defined and may be added via extensions.',
  relationships: emptyRels(),
  example: {},
...
const note: StixObjectType = {
  ...
  relationshipNote: 'Note references objects through its object_refs property rather than SRO relationships. Custom relationships may be defined via extensions.',
  relationships: emptyRels(),
  example: {},
...
const opinion: StixObjectType = {
  ...
  relationshipNote: 'Opinion references objects through its object_refs property rather than SRO relationships. Custom relationships may be defined via extensions.',
  relationships: emptyRels(),
  example: {},
...
const report: StixObjectType = {
  ...
  relationshipNote: 'Report references objects through its object_refs property rather than SRO relationships. Custom relationships may be defined via extensions.',
  relationships: emptyRels(),
  example: {},
...
const relationship: StixObjectType = {
  ...
  relationshipNote: 'Relationship objects ARE relationships — they connect other objects via source_ref and target_ref. They do not participate in SRO relationships themselves.',
  relationships: emptyRels(),
  example: {},
...
const sighting: StixObjectType = {
  ...
  relationshipNote: 'Sighting objects ARE relationships — they link observed intelligence to identities via sighting_of_ref and where_sighted_refs. They do not participate in SRO relationships themselves.',
  relationships: emptyRels(),
  example: {},
...
const bundle: StixObjectType = {
  ...
  relationshipNote: 'Bundle is a transport container and does not have spec-defined SRO relationships. However, relationships to and from bundles may be defined through extensions.',
  relationships: emptyRels(),
  example: {},
...
const extensionDefinition: StixObjectType = {
  ...
  relationshipNote: 'Extension Definition is a meta object that defines how to extend STIX. It does not participate in SRO relationships itself, but the extensions it defines may introduce new relationship types.',
  relationships: emptyRels(),
  example: {},
...
const languageContent: StixObjectType = {
  ...
  relationshipNote: 'Language Content references objects through its object_ref property rather than SRO relationships. It provides translations for a specific object.',
  relationships: emptyRels(),
  example: {},
...
const markingDefinition: StixObjectType = {
  ...
  relationshipNote: 'Marking Definition is applied to objects via the object_marking_refs property rather than SRO relationships. It does not participate in SRO relationships.',
  relationships: emptyRels(),
  example: {},
